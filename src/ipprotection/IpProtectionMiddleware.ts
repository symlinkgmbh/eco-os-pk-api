...
const extractAddress = (req: Request): string | null => {
...
const ipProtectionMiddleware = async (req: Request, _res: Response, next: NextFunction) => {
    ...
    const ipProtectionService: PkCore.IEcoIpProtectionClient = serviceContainer.get<PkCore.IEcoIpProtectionClient>(ECO_OS_PK_CORE_TYPES.IEcoIpProtectionClient);
